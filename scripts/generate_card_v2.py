#!/usr/bin/env python3
"""
Generate a transparent neofetch-style animated SVG profile card.
"""
...
LOGIN = os.environ.get("GITHUB_LOGIN", "Chahethsen12")
...
PROFILE_FIELDS = [
    ...
    ("LinkedIn", "linkedin.com/in/chaheth-senevirathne"),
]
